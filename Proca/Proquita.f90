program Proquita
    ...
    m(1) = (sexto*F1**2)*r(1)**3
    s(1) = uno + (medio*F1**2)*r(1)**2 
    F(1) = F1 + ( sexto*(F1*(uno - w**2)) )*r(1)**2
    G(1) = -tercio*F1*w*r(1)
    ...
    do i=1, Nr-1
        ...
        !------------------------------------------------
        call derivadasP(w, r(i), m(i), s(i), F(i), G(i), &
        dm, ds, dF, dG)
        ...
        !------------------------------------------------
        call derivadasP(w, r(i) + medio*dr, m(i) + medio*k1m*dr, s(i) + medio*k1s*dr, F(i) + medio*k1F*dr, G(i) + medio*k1G*dr, &
        dm, ds, dF, dG)
        ...
        !------------------------------------------------
        call derivadasP(w, r(i) + medio*dr, m(i) + medio*k2m*dr, s(i) + medio*k2s*dr, F(i) + medio*k2F*dr, G(i) + medio*k2G*dr, &
        dm, ds, dF, dG)
        ...
        !------------------------------------------------
        call derivadasP(w, r(i) + dr, m(i) + k3m*dr, s(i) + k3s*dr, F(i) + k3F*dr, G(i) + k3G*dr, &
        dm, ds, dF, dG)
...
subroutine derivadasP(w, r, m, s, F, G, dm, ds, dF, dG)
